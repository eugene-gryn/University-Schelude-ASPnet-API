...
namespace MainDesktop
{
    ...
    public partial class MainWindow : Window
    {
        ...
        private ScheduleEngine sheldue = new ScheduleEngine();
        ...
        public MainWindow()
        {
            ...
            try
            {
                ScheduleEngine loadedSheldue = json.LoadObj(saveFileName);
        ...
        private void CoupleViewUpdate()
        {
            if (sheldue.Logged && sheldue.Sheldues.Count > 0)
            {
                ...
                DaysOfWeek day = ScheduleEngine.ConvertDaysOfWeek(PickSheldueDate.SelectedDate.Value.DayOfWeek);
